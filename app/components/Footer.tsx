...
const Footer = () => {
  ...
  const services = [
    { label: "Website Development", href: "services.html#webdev" },
    { label: "Digital Marketing", href: "services.html#marketing" },
  ];

  const contactItems = [
    {
      href: "mailto:info@technostart.com",
      label: "info@technostart.com",
      sublabel: "Email us",
      icon: (
          ...
          <div className="lg:col-span-5 space-y-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold tracking-tight text-white">
                TECHNO<span className="text-blue-400">START</span>
              </span>
            </div>
