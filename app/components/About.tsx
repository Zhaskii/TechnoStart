  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-blue-50/30 to-white">
      <main>
            ...
            {[
              ...
              >
                <div className="group relative h-full rounded-2xl overflow-hidden bg-white border border-blue-100/50 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 p-8 lg:p-10">
                  <div className={`absolute top-0 right-0 w-32 h-32 rounded-full bg-gradient-to-br ${color} opacity-10 -mr-16 -mt-16`} />
                  <div className="relative">
                    <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${color} flex items-center justify-center mb-6 text-white shadow-lg group-hover:scale-110 transition-transform`}>
                      <Icon size={24} />
                    </div>
        ...
        {/* ── Core Values ── */}
        <section className="py-20 lg:py-28 about-values-trigger bg-gradient-to-br from-blue-50/50 via-white to-blue-50/50">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16 about-values-wrapper opacity-0">
              <div className="inline-flex items-center gap-2 rounded-full border border-blue-200/50 bg-blue-50/50 backdrop-blur px-4 py-2 mb-6">
                ...
                <span className="text-sm font-bold text-blue-700">Our Core Values</span>
              </div>
              ...
              {values.map(({ icon: Icon, title, desc }) => (
                ...
                >
                  <div className="bg-white h-full rounded-2xl border border-blue-100/50 p-7 hover:-translate-y-2 hover:shadow-xl hover:border-blue-200/80 transition-all duration-500 group">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-600 to-blue-500 flex items-center justify-center mb-5 text-white group-hover:scale-110 transition-transform">
                      <Icon size={20} />
                    </div>
            ...
            {team.map(({ initials, name, role, color }) => (
              ...
              >
                <div className="bg-white h-full rounded-2xl border border-blue-100/50 p-8 text-center shadow-lg hover:shadow-2xl hover:-translate-y-2 hover:border-blue-200/80 transition-all duration-500 group relative overflow-hidden">
                  ...
                  <div className={`w-20 h-20 rounded-2xl mx-auto flex items-center justify-center text-2xl font-bold text-white ${color} mb-6 group-hover:scale-110 transition-transform shadow-lg select-none relative z-10`}>
                    {initials}
                  </div>
        ...
        <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mb-32 about-cta-trigger">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-600 to-blue-800 px-8 py-16 sm:px-16 text-center text-white about-cta-anim opacity-0 shadow-2xl">
            ...
            <div className="relative max-w-2xl mx-auto">
              <h2 className="text-3xl sm:text-4xl font-bold mb-6 leading-tight">
                Ready to Transform Your <span className="text-blue-200">Digital Presence?</span>
              </h2>
              <p className="text-blue-50 leading-relaxed mb-10 text-lg">
                Our proven track record, transparent processes, and uncompromising focus on ROI make us a dependable long-term partner for your growth.
              </p>
              <a
                href="contact.html"
